...
(function($) {
    ...
    $.widget("ui.datagrid" , {
		...
		reload : function (param){
			var self = this;
			return self.element.each(function() {
				self._loadData(self.element, param);
			});
		},
		/**
		 * 重载行底记录 
		...
		_initGrid : function (target){
			...
			if(opts.toolbar) {
				if( typeof opts.toolbar == "string") {
					...
					var tb = $('<div class="datagrid-toolbars"></div>').prependTo(datagrid);
					tb.toolbar({
						item : opts.toolbar
					});
		...
		_setSize : function (target){
			...
			if(opts.height != "auto") {
				var bodyHeight = gridHeight 
					- view2.children("div.datagrid-header").outerHeight(true) 
					- view2.children("div.datagrid-footer").outerHeight(true) 
					- datagrid.children("div.datagrid-toolbars").outerHeight(true) 
					- datagrid.children("div.datagrid-pager").outerHeight(true);
